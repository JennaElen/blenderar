...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        xrOnSelect, unbindListener, LIST_NONE, getEventOffsetCoords,
        isChangedTouchOrNotTouchEventAtAll, getEventFirstTouchId, createDragOverInfo,
    };
};
...
function show_warning(id) {
    setHTMLElemStyle('display', 'block', 'warning_centre', false);
    setHTMLElemStyle('display', 'block', id, false);
    registerSetTimeout(3, function() {
        setHTMLElemStyle('display', 'none', 'warning_centre', false);
...
createCSSRule('.info', "position: absolute; width: 50px; height: 50px; z-index: 1; top: 10px; right: 10px; background-repeat: no-repeat; display: block; overflow: hidden; border-style: none; border-color: #000000; cursor: pointer;", false, '');
addHTMLElement('a', 'info_button', 'TO', ['CONTAINER'], false);
setHTMLElemAttribute('className', 'info-button', 'info_button', false);
setHTMLElemAttribute('href', 'https://sathvick.com', 'info_button', false);
...
operateAnimation('PLAY', 'jen_armature', 0, 180, 'LoopRepeat', 1, function() {}, false);

volume(loadMedia_WebAudio('sounds/hello.mp3'), 0.5);
registerOnClick('jen_mesh', false, false, [0,1,2], false, function(event) {
    operateAnimation('STOP', 'jen_armature', null, null, 'AUTO', 1, function() {}, false);
    playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);
    operateAnimation('PLAY', 'jen_armature', 181, 265, 'LoopOnce', 1, function() {
        operateAnimation('PLAY', 'jen_armature', 0, 180, 'LoopRepeat', 1, function() {}, false);
    }, false);
}, function(event) {});
...
checkARMode(function() {
    eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
        enterARMode('ORIGIN', true, function() {
            ...
            changeVis(['GROUP', 'jen_grp'], true);
            changeVis('prompt_move_around', false);
            setObjTransform('jen_armature', false, 'position', createVector(0, 0, 0), false);
            setHTMLElemStyle('display', 'block', 'enter_AR_button', false);
            changeVis(['drag_move', 'drag_rotate', 'drag_scale', 'scale_percentage', 'ready_button'], false);
            setObjTransform('jen_armature', false, 'position', [1, 1, 1], false);
    ...
    setHTMLElemAttribute('href', exportToUSDZ('jen_mesh'), 'enter_AR_button', false);
    setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
    setHTMLElemAttribute('download', 'sudhi.usdz', 'enter_AR_button', false);
}, function() {
    eventHTMLElem('click', 'myElem', false, function(event) {
        show_warning('warning_AR_unavailable');
    });
});

registerOnClick('indicator_invis_plane', false, false, [0,1,2], false, function(event) {
    changeVis(['GROUP', 'jen_grp'], true);
    changeVis(['GROUP', 'indicator_group'], false);
    setObjTransform('jen_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
    setObjDirection('jen_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
    changeVis(['scale_percentage', 'ready_button', 'edit_button', 'drag_move', 'drag_rotate', 'drag_scale'], false);
}, function(event) {});

registerOnClick('edit_button', false, false, [0,1,2], false, function(event) {
...
registerOnClick('ready_button', false, false, [0,1,2], false, function(event) {
    registerSetTimeout(0.1, function() {
...
registerOnDrag('drag_move', false, [0,1,2], function(event) {}, function(event) {
    dragMoveAdv('jen_armature', 'XY', 'WORLD', 'PPo::@kW)2jNCHZIR2aK', 'gPB)$Mg}*Pc2WhzZ9g[E');
}, function(event) {}, 'gPB)$Mg}*Pc2WhzZ9g[E');

registerOnDrag('drag_rotate', false, [0,1,2], function(event) {}, function(event) {
    dragRotateAdv('jen_armature', 'Z', 'WORLD', 'Hyl^B,];nFJ.uf~i,~sb', 'IDia0$%5C6mFKK9KLNRF');
}, function(event) {}, 'IDia0$%5C6mFKK9KLNRF');

registerOnDrag('drag_scale', false, [0,1,2], function(event) {}, function(event) {
    dragScale('jen_armature', 'Z', 'PKk8DhAtaOHoQ/7xBZ{g', 'F}qekkJ`m8lX+Cd6nO8d');
    dragScale('jen_armature', 'X', 'f^0Nq$8W[~=vtB.Q:`|:', 'F}qekkJ`m8lX+Cd6nO8d');
    dragScale('jen_armature', 'Y', 'f@Hz8=a~{Ib2M?!-MEz@', 'F}qekkJ`m8lX+Cd6nO8d');
    updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('jen_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function(event) {}, 'F}qekkJ`m8lX+Cd6nO8d');
